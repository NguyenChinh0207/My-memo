...
import { ADMIN_FORGOT_PASSWORD, EVENT, TENANT_DETAIL_PATH, SEARCH_PARKING_PATH, CUSTOMER_PATH } from '../../config/path'
import { getUserTenantId, getMallId, bindParams } from '../../config/function'
                            ...
                            <Form layout={'vertical'} onFinish={onFinish} onValuesChange={onValuesChange}>
                                ...
                                <Space direction="vertical" size={'large'} className={'w-100'}>
                                    <div className="login__form--forgot-password">
                                        <NavLink to={ADMIN_FORGOT_PASSWORD}>{t('forgot_password')}</NavLink>
                                    </div>
                                    <Button
                                        size={'large'}
                                        block
